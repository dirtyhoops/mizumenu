...
export const hotAppetizersImages = [
  { name: 'Assorted Tempura', link: AssortedTempura },
  { name: 'Baked Green Mussels', link: Mussels },
  { name: 'Groyza', link: Gyoza },
  { name: 'Agedashi Tofu', link: AgedashiTofu },
  { name: 'Crispy Rice', link: CrispyRice },
  { name: 'Honeymoon Special', link: HoneymoonSpecial },
  { name: 'Hamachi Kama', link: HamachiKama },
  { name: 'Spicy Popcorn Scallops', link: SpicyPopcorn },
  { name: 'Croquettes', link: Croquette },
  { name: 'Calamari', link: Calamari }
];

export const coldAppetizersImages = [
  { name: 'Yellowtail Tartar', link: YellowtailTartar },
  { name: 'Tuna Tartar', link: TunaTartar },
  { name: 'Mizu Bomb', link: MizuBomb },
  { name: 'Salmon Carpaccio', link: SalmonCarpaccio },
  { name: 'Yellowtail Crudo', link: YellowtailCrudo },
  { name: 'Cajun Tuna Sashimi', link: CajunTuna },
  { name: 'Citrus Seared Salmon', link: CitrusSearedSalmon }
];

export const rollsImages = [
  { name: 'Sakura', link: Sakura },
  { name: 'Popcorn Lobster', link: PopcornLobster },
  { name: 'Super Godzilla', link: SuperGodzilla },
  { name: 'Hot Mango', link: HotMango },
  { name: 'CherryBlossom', link: CherryBlossom },
  { name: 'Albacore Delight', link: AlbacoreDelight },
  { name: 'Titanic Fire', link: Titanic },
  { name: 'Hurricane', link: Hurricane },
  { name: 'butterfly', link: Butterfly },
  { name: 'Yellowtail Special', link: YellowtailSpecial },
  { name: 'Rainbow', link: Rainbow },
  { name: 'Dragon', link: Dragon },
  { name: 'Green Dragon', link: GreenDragon },
  { name: 'Red Dragon', link: RedDragon },
  { name: 'Crazy Dragon', link: CrazyDragon },
  { name: 'MizuJumbo', link: MizuJumbo },
  { name: 'Unagi Lover', link: UnagiLover },
  { name: 'Sunkissed', link: Sunkissed },
  { name: 'Alaska', link: Alaska },
  { name: 'Super Spider', link: SuperSpider },
  { name: 'Yami Yami', link: YamiYami },
  { name: 'Spicy Crunch', link: SpicyCrunch }
];

export const entreesImages = [
  { name: 'Miso Black Cod', link: MisoBlackCod },
  { name: 'Salmon Teriyaki', link: SalmonTeriyaki },
  { name: 'Chicken Katsu', link: ChickenKatsu },
  { name: 'Galbi', link: Galbi },
  { name: 'Beef Bulgogi', link: BeefBulgogi },
  { name: 'Chicken Bulgogi', link: ChickenBulgogi },
  { name: 'Spicy PorkBulgogi', link: SpicyPorkBulgogi },
  { name: 'House Boat', link: HouseBoat },
  { name: 'Kake Udon', link: KakeUdon },
  { name: 'Tempura Udon', link: TempuraUdon },
  { name: 'Nabeyaki Udon', link: NabeyakiUdon },
  { name: 'Pork Donburi', link: PorkDonburi }
];

export const saladImages = [
  { name: 'Mizu House Salad', link: MizuHouseSalad },
  { name: 'spicy Tuna Salad', link: SpicyTunaSalad }
];

export const sideImages = [{ name: 'Seaweed Salad', link: Seaweed }];

export const sushiSashimiImages = [
  { name: 'Chirashi', link: Chirashi },
  { name: 'Sashimi (9pcs)', link: SashimiNinePcs },
  { name: 'Sushi Dinner', link: SushiDinner },
  { name: 'Sushi & Sashimi Dinner', link: SushiSashimiDinner },
  { name: 'Signature Boat', link: SignatureBoat }
];
