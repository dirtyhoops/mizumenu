...
export const dinnerColdAppetizers = [
  ...
  },
  {
    ...
    description:
      'salmon sashimi with red onion,, orange zest, bonito flakes, ponzu sauce & olive oild',
    price: 15.5,
  },
  {
    name: 'tako carpacio',
    description:
      'octopus sashimi with wasabi garlic aioili black tobiko, serrano peppers, olive oil, rosa salt, lemon juice & house nikiri soy',
    price: 16.5,
  },
];
...
export const dinnerSushiSashimi = [
  ...
  },
  {
    ...
    description:
      "chef's selection of 7 pcs of suhi and 12 pcs of sashimi with tuna roll served with rice & miso soup",
    price: 57,
  },
  {
    name: 'signature boat',
